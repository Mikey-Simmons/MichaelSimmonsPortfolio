  ...
  return (
    <div>
      <Jumbotron>
        ...
        <ListGroup flush>
      Phone Number: <ListGroupItem className="listy"  tag="a" href="tel:+12064681060">(206)-468-1060</ListGroupItem>
     Email: <ListGroupItem className="listy" tag="a" href="mailto: mikeysimmons425@gmail.com">mikeysimmons425@gmail.com</ListGroupItem>
